# Reflector Hobgoblin - Test Conditions

## Overview

This document specifies comprehensive test conditions for the Reflector hobgoblin. Reflector learns from turn outcomes and updates consciousness, episodic memory, and skills.
...
**Condition**: Reflector learns, other hobgoblins use learning
**Expected**: Learning propagates
**Verification**:
- Learning available to hobgoblins
...
6. ✓ Learning propagates to other hobgoblins
